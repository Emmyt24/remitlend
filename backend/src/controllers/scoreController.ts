...
import { calculateTieredScore, getScoreWithConfidence } from '../services/bayesianScoringService.js';
 ...
 * confidence level, and Bayesian credible interval. Uses tiered scoring where
 * new users get meaningful initial scores from the first remittance, with
 * improved confidence after N transactions.
 */
